...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      isScrolled 
        ? 'bg-orange-500 backdrop-blur-xl border-b border-orange-800/30 shadow-lg shadow-black/10' 
        : 'bg-orange-500/95 backdrop-blur-md border-b border-orange-800/20'
    }`}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-24">
          ...
          <div className="flex items-center lg:flex-none flex-1 lg:flex-initial justify-center lg:justify-start">
            <Link to="/" onClick={handleNavClick} className="group">
              <img 
                src="/lovable-uploads/lm-logo.png" 
                alt="LM-Heizöl" 
          ...
          <div className="flex items-center space-x-4">
            <button 
              ...
              className="hidden sm:flex items-center space-x-2 bg-white text-orange-600 px-6 py-2.5 rounded-xl font-medium shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-black/20 hover:bg-gray-50 transition-all duration-300 hover:scale-105"
            >
        ...
        <div className={`lg:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="py-4 border-t border-orange-800/30">
            <nav className="flex flex-col space-y-1">
              ...
              <button 
                onClick={scrollToPriceCalculator}
                className="sm:hidden mt-4 flex items-center justify-center space-x-2 bg-white text-orange-600 px-4 py-3 rounded-xl font-medium shadow-lg shadow-black/10"
              >
                <Calculator className="w-4 h-4" />
                <span>zum Preisrechner</span>
              </button>
