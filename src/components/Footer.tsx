...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-orange-500">
      {/* Background Pattern */}
      ...
      <div className="relative">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="group flex items-start space-x-3">
                  ...
                  <span className="text-gray-200 text-sm">Alsterufer 20, 20354 Hamburg</span>
                </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/20 bg-orange-800/50 backdrop-blur-sm">
          <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-white/90 text-sm">
                <span className="text-center sm:text-left">© 2025 LM-Heizöl. Alle Rechte vorbehalten.</span>
                <span className="text-center sm:text-left">Amtsgericht Hamburg HRB 130020 | USt-ID: DE427997469</span>
              </div>
