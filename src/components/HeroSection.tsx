  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 to-white relative overflow-hidden pt-32 pb-16">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255,165,2,0.12) 0%, rgba(255,165,2,0.06) 40%, transparent 70%)',
          filter: 'blur(60px)',
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255,165,2,0.1) 0%, rgba(255,165,2,0.04) 35%, transparent 65%)',
          filter: 'blur(70px)',
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255,180,50,0.08) 0%, rgba(255,165,2,0.03) 45%, transparent 70%)',
          filter: 'blur(80px)',
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255,180,50,0.09) 0%, transparent 60%)',
          filter: 'blur(50px)',
          animationDelay: '3s'
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255,165,2,0.07) 0%, rgba(255,180,50,0.04) 50%, transparent 70%)',
          filter: 'blur(65px)',
          animationDelay: '5s'
        }}
      ></div>
          ...
          <div className="space-y-10 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full px-4 py-2 shadow-sm">
                ...
                <span className="text-sm font-medium text-gray-700">Seit 2014 – 11 Jahre Expertise</span>
              </div>
              <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full px-4 py-2 shadow-sm">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <h1 className="text-5xl lg:text-6xl xl:text-7xl font-black text-gray-900 leading-[0.9] tracking-tight">
                  <span className="text-orange-600 font-black">Günstigster Heizöl-Anbieter</span>
                  <br />
                  <span className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-600">aus Hamburg für ganz Deutschland</span>
                </h1>
              ...
              <h2 className="text-2xl lg:text-3xl text-gray-700 font-light leading-relaxed">
                Premium Heizöl ab <span className="font-bold text-orange-600">70 Cent pro Liter</span>
                <br />
                <span className="text-xl text-gray-600">Kostenlose Lieferung ab 2.000L – von Hamburg nach ganz Deutschland</span>
              </h2>
            </div>
            ...
            <div className="space-y-4">
              <p className="text-xl text-gray-700 leading-relaxed">
                Seit 2014 liefern wir als moderner Heizöl-Händler aus Hamburg Premium-Qualität 
                zu<span className="font-semibold text-orange-600"> bis zu 30% günstigeren Preisen</span> als lokale Anbieter – deutschlandweit. 
                11 Jahre Erfahrung garantieren höchste Qualität und Zuverlässigkeit.
              </p>
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <div className="w-2 h-2 bg-orange-500 rounded-full animate-pulse"></div>
                <span>Von Hamburg aus vertrauen über 100.000 Kunden bundesweit auf unsere Qualität</span>
              </div>
            </div>
          </div>
