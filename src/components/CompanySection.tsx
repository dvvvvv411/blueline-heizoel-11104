...
const CompanySection = () => {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      content: (
        <a 
          href="mailto:info@lm-heizoel.de" 
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-orange-50/30 to-orange-50/20 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(255,165,2,0.06),transparent)]"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          {/* Company Info */}
          <div className="animate-fade-in">
            <div className="inline-block bg-orange-500/10 text-orange-700 px-6 py-2 rounded-full text-sm font-semibold mb-6">
              Über uns
            </div>
            
            <h2 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-8">
              Über <span className="gradient-text">LM-Heizöl</span>
            </h2>
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed mb-12">
              ...
              <p>
                ...
                <span className="font-semibold text-orange-700"> Premium Heizöl ab 70 Cent pro Liter</span> – von Hamburg nach ganz Deutschland geliefert.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {qualityFeatures.map((feature, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className="group bg-white/80 backdrop-blur-md border border-orange-200/50 rounded-2xl p-6 shadow-md hover:shadow-lg hover:-translate-y-1 hover:bg-white/90 transition-all duration-500 animate-fade-in"
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
            {/* Contact Card */}
            <div className="bg-white/85 backdrop-blur-md border border-orange-200/50 rounded-3xl p-8 mb-8 shadow-md hover:shadow-xl hover:bg-white/93 transition-all duration-500">
            ...
            <div className="bg-gradient-to-br from-gray-50/50 to-white/50 border border-gray-200/50 rounded-3xl p-8">
              ...
              <div className="space-y-3 text-center">
                <div className="p-4 bg-white/50 rounded-2xl">
                  <p className="font-semibold text-gray-900">LM-Heizöl (LM Lubricants GmbH)</p>
                </div>
                <div className="p-4 bg-white/50 rounded-2xl">
                  <p className="text-gray-700">Amtsgericht Hamburg HRB 130020</p>
                </div>
                <div className="p-4 bg-white/50 rounded-2xl">
                  <p className="text-gray-700">USt-ID: DE427997469</p>
                </div>
              </div>
            </div>
          </div>
