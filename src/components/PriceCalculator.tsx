...
const PriceCalculator = () => {
  ...
  const handleOrder = async () => {
    ...
    const orderData: OrderData = {
      shop_id: "94c1869d-c1e2-4bb5-a41a-dcbb0d770619",
  ...
  return (
    <div id="price-calculator" className="glassmorphism-card p-8 animate-scale-in max-w-5xl mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="flex flex-col h-full space-y-6">
          {/* Price Breakdown */}
          <div className="flex-1 flex flex-col bg-white/75 border border-orange-200/50 rounded-xl p-6 space-y-4 shadow-sm">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <span className={`font-semibold whitespace-nowrap ${deliveryFee === 0 ? 'text-orange-600' : ''}`}>
            ...
            <div className="border-t pt-4">
              ...
              <p className="text-4xl font-extrabold text-orange-600 whitespace-nowrap mt-1">{totalPrice.toFixed(2)} €</p>
          ...
          <div className="mt-auto">
            <Button 
              ...
              className="w-full bg-orange-500 hover:bg-orange-600 text-white text-lg py-6 rounded-xl font-semibold transition-all hover-scale"
            >
              {isProcessing ? (
                <div className="flex items-center space-x-2">
