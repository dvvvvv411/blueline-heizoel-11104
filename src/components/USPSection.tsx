...
const USPSection = () => {
  const usps = [
    ...
    },
    {
      ...
      description: "Von Hamburg aus liefern wir deutschlandweit kostenfrei ab 2.000L. Zuverlässige Premium-Anlieferung zu Ihrem Wunschtermin – egal wo in Deutschland Sie sind.",
  ...
  const stats = [
    { icon: TrendingDown, value: "100.000+", label: "Zufriedene Kunden", color: "text-orange-600" },
    ...
    { icon: Shield, value: "99%", label: "Kundenzufriedenheit", color: "text-blue-600" }
  ];

  return (
    <section className="py-24 bg-gradient-to-b from-orange-50/30 to-white relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(255,165,2,0.06),transparent)]"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          {usps.map((usp, index) => {
            ...
            return (
              <div 
                key={index}
                className="group relative bg-white/80 backdrop-blur-md border border-orange-200/50 rounded-3xl p-8 shadow-md hover:shadow-2xl hover:shadow-orange-600/10 hover:bg-white/90 hover:backdrop-blur-lg transition-all duration-700 hover:-translate-y-2 animate-fade-in"
        ...
        {/* Stats Section */}
        <div className="bg-white/85 backdrop-blur-md rounded-3xl border border-orange-200/50 p-8 md:p-12 shadow-md">
