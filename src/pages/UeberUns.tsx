...
const UeberUns = () => {
  return (
    <div className="min-h-screen">
      <SEO
        title="Über uns & Service | LM-Heizöl | Premium Heizöl-Händler"
        description="LM-Heizöl – Ihr vertrauensvoller Partner für Heizöl. Innovatives Unternehmen aus Hamburg mit über 100.000 zufriedenen Kunden deutschlandweit."
        keywords="LM-Heizöl, Hamburg, Heizöl Unternehmen, Premium Heizöl"
        canonicalUrl="https://lm-heizoel.de/ueber-uns"
      />
      <Header />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Ihr vertrauensvoller Partner für Heizöl in Hamburg und ganz Deutschland. 
      ...
      <PageSection className="py-24" background="warm">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">LM-Heizöl</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ihre vertrauensvolle Adresse für Premium-Heizöl aus Hamburg
            </p>
          </div>
              ...
              <div className="relative bg-white/85 backdrop-blur-md border border-red-200/50 rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-white/93 transition-all duration-300">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-4 bg-primary/5 rounded-xl border border-primary/20">
                    ...
                    <span className="font-bold text-gray-900">Hamburg</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
      ...
      <PageSection background="primary" className="py-24">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Ihre Ansprechpartner in Hamburg - wir sind für Sie da
            </p>
          </div>
          ...
          <div className="relative bg-white/85 border border-red-200/50 rounded-3xl p-10 shadow-lg backdrop-blur-md hover:shadow-xl hover:bg-white/93 transition-all duration-300">
                ...
                <div className="space-y-6 text-center">
                  <div className="p-4 bg-white/60 rounded-xl border border-white/40">
                    <p className="font-bold text-lg text-gray-900 mb-2">LM-Heizöl (LM Lubricants GmbH)</p>
                  ...
                  <div className="p-4 bg-white/60 rounded-xl border border-white/40">
                    <p className="text-gray-700">
                      <strong className="text-primary">E-Mail:</strong> info@lm-heizoel.de
                    </p>
                  </div>
                </div>
              </div>
