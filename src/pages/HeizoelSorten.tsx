...
const HeizoelSorten = () => {
  return (
    <div className="min-h-screen">
      <SEO
        title="Heizöl-Sorten | Standard & Premium Heizöl | LM-Heizöl"
        ...
        keywords="Heizöl Sorten, Standard Heizöl EL, Premium Heizöl Plus, schwefelarmes Heizöl, DIN 51603-1, Hamburg"
        canonicalUrl="https://lm-heizoel.de/heizoelsorten"
      />
      <Header />
