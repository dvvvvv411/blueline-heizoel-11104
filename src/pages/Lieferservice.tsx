...
const Lieferservice = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Deutschlandweite Heizöl-Lieferung | 4-7 Werktage | LM-Heizöl"
        ...
        canonicalUrl="https://lm-heizoel.de/lieferservice"
      />
      <Header />
      ...
      <PageSection className="py-24" background="warm">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Warum LM-Heizöl?</h2>
