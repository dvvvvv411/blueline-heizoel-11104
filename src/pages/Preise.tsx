...
const Preise = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Heizöl Preise & Konditionen | Ab 70 Cent/L | LM-Heizöl"
        ...
        keywords="Heizöl Preise, Heizöl Kosten, Preisgarantie, transparente Preise, Heizöl günstig kaufen, Hamburg"
        canonicalUrl="https://lm-heizoel.de/preise"
      />
      <Header />
